...
const fetchAPI = async (url, params = {}, responseType = "json") => {
    try {
        ...
        console.log(
            chalk.black(chalk.bgGreenBright(' [fetchAPI] ')),
...
module.exports = {
    ...
    tebakgambar: () => fetchAPI("https://raw.githubusercontent.com/riycs/scrape-2/master/games/tebakgambar.json"),
    kuis: () => fetchAPI("https://raw.githubusercontent.com/riycs/scrape-2/master/games/tekateki.json")
};